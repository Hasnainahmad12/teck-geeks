...
import { useDeleteAsinMutation } from "../../apis/Asin/Asin";

function DeleteAsin({ onClose, id }) {
  ...
  useEffect(() => {
    if (isSuccess) {
      ...
      toast.error(error?.data?.error || "Failed to delete Asin");
    }
