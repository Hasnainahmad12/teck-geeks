...
import { useCreateSuiteMutation } from "../../apis/EngageSuites/SuitesSlice";
import { IoCloudUploadOutline } from "react-icons/io5";

function AddSuites({ onClose }) {
  ...
  const [createSuite, { isLoading, isSuccess, isError, error }] =
  ...
  useEffect(() => {
    ...
    if (isError) {
      toast.error(error?.data?.error || "Error Creating Suite");
    }
